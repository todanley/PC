...
app-data dir (%LOCALAPPDATA%\\UnboundComputerUse on Windows, ~/Library/Application
Support/UnboundComputerUse on macOS). Best-effort — failures degrade to "no token"
rather than raising.
"""
import json
import os
...
def _path() -> Path:
    ...
    return base / "UnboundComputerUse" / "token.json"
